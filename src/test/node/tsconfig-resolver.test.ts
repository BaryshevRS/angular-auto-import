...
describe("TsConfigResolver", function () {
  ...
  describe("#resolveImportPath", () => {
    ...
    describe("Edge Cases", () => {
      ...
      it("should select the same module-specifier styles as TypeScript", async () => {
        ...
        assert.strictEqual(
          await TsConfigHelper.resolveImportPath(targetPath, currentFile, testProjectPath, "shortest"),
          "../shared/pipes/number-separator.pipe"
        );
        assert.strictEqual(
          await TsConfigHelper.resolveImportPath(targetPath, currentFile, testProjectPath, "relative"),
          "../shared/pipes/number-separator.pipe"
        );
        assert.strictEqual(
          await TsConfigHelper.resolveImportPath(targetPath, currentFile, testProjectPath, "non-relative"),
          "~/app/project/mobile/shared/pipes/number-separator.pipe"
        );
        assert.strictEqual(
          await TsConfigHelper.resolveImportPath(targetPath, currentFile, testProjectPath, "project-relative"),
          "../shared/pipes/number-separator.pipe"
        );
      });
    });
