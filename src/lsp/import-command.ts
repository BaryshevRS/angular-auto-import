...
import type { ImportFormattingOptions } from "../core/import-planner";
...
export class ImportCommandHandler {
  ...
  constructor(private readonly options: ImportCommandHandlerOptions) {
    ...
    this.planner = new ImportEditPlanner({
      ...
      resolveFormatting: options.resolveFormatting ?? ((filePath) => resolveImportFormatting(filePath, this.logger)),
      logger: this.logger,
    });
  }
