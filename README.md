...
[![Clone Alert](https://img.shields.io/badge/Clone%20Alert-0%20clones-brightgreen?style=flat-square)](https://www.npmjs.com/package/clone-alert)
...
| ------- | ----------- | ----------- |
| **Audit Project-Wide Missing Imports** | Scans opened and unopened templates and links every finding to its exact source range | Before a commit or release, or after a large refactor |
